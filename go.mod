module gitlab.consulting.redhat.com/mobb/tekton-polling-operator
...
require (
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20220414094046-0a4d154ec52c // indirect
